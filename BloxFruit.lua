...
getgenv().ToTarget=function(p)
	...
	pcall(function() tween = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart,TweenInfo.new(Distance/210, Enum.EasingStyle.Linear),{CFrame = p}) end)
	tween:Play()
...
function TP(p)
	Distance = (p.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
	if Distance < 250 then
		Speed = 600
	elseif Distance >= 1000 then
		Speed = 200
...
function library:CreateWindow(options, ...)
	...
	function windowFunctions:CreateDesigner(options, ...)
		...
		local daaata = {{"AddTextbox", "__Designer.Textbox.ImageAssetID", backgroundsection, {
			Name = "Image Asset ID",
			Placeholder = "rbxassetid://3242749167",
			Flag = "__Designer.Background.ImageAssetID",
			Value = "rbxassetid://3242749167",
...
SettingSection:AddToggle{
    ...
    Flag = "Supper_Fast",
    Value = _G.Settings.Supper_Fast,
    Callback  = function(value)
        _G.Supper_Fast = value
		_G.Settings.Supper_Fast = value
		saveSettings()
    end
}
...
local JoinSection = Visuals:CreateSection({
    Name = "Join",
	Side = "Right"
})
...
local OpenMenuSection = Visuals:CreateSection({
    Name = "Open Menu",
	Side = "Right"
})
...
local MainMiscSection = Visuals:CreateSection({
    Name = "Screen",
	Side = "Left"
})
...
local Check  = PepsisWorld:CreateTab({
    Name = "Check"
})
	

local PlayerStatsSection = Check:CreateSection({
    Name = "Player Stats",
	Side = "Right"
})
...
local PlayerSwordSection = Check:CreateSection({
    Name = "Player Sword",
	Side = "Left"
})
...
local PlayerFightingStyleSection = Check:CreateSection({
